...
---
Thank you to the Buerk Center for Entrepreneurship (University of Washington) - for the $2,000 grant. This wouldn't have been possible without them. 
...
To solve this, we built the following:
...
- **Zero persistence audio architecture** - all audio is processed in RAM via an on device Vosk model. None of the data is written on the disk and none of the data is transmitted to remote servers and no conversation is retained after the session either. All of this is for privacy.
